...
Make sure `sonar.host.url` is set to `localhost:9000` 5. Perform SonarQube scan in the project directory by running `sonar-scanner` 6. Check [http://localhost:9000/](http://localhost:9000/) to see that the result is written to the SonarQube server.
